				 ...
				 if(data.status !== "success") {
					...
					if ( !data.is_super_admin ) {
						...
						self._includeAjaxManager();
							dojo.place('<li><div id="main" class="main-wrapper"><div><div class="column-main" role="main"><div class="container-fluid"><div class="row-fluid"><div class="search-bar"><input type="search" name="searchText" id="search-nav-bar" class="search-query" placeholder="Search for Books, Articles, Videos, Audio, and more…" value><button onclick="searchExchange()" class="ecollege_search"></button><div class="search-filter-list" style="display: none"></div></div></div></div></div></div></div></div></div><div id="results" class="ecollege_header_dialogPopup"></div><div><iframe id="PreviewPane" style="border-width:0;" width="250" height="250"></iframe></div></li>', self.myBarNode );
